...
```{r}
Full <- lm(Y ~ X1 + X2 + X3, data=q11)
Reduced <- lm(Y ~ X1, data=q11)
anova(Reduced, Full)
```
...
summary(cars.lm)
predict(cars.lm, data.frame(speed=25), level=.99, interval="predict")
```
...
summary(lm(HT18 ~ HT2 + I(HT2^2), data=BGSboys))
summary(lm(HT18 ~ HT2 + I(HT2^2) + I(HT2^3), data=BGSboys))
summary(lm(HT18 ~ HT2 + I(HT2^2) + I(HT2^3) + I(HT2^4), data=BGSboys))
```
...
plot(lm(HT18 ~ HT2 + Sex, data=BGS), which=1:2)

summary(lm(HT18 ~ HT2 + Sex + HT2:Sex, data=BGS))
plot(lm(HT18 ~ HT2 + Sex + HT2:Sex, data=BGS), which=1:2)

summary(lm(HT18 ~ HT2, data=BGS))
plot(lm(HT18 ~ HT2, data=BGS), which=1:2)
